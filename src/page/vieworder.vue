<template>
  <div class="view-order">
    <div class="view-order-head">
      ...
      <div class="view-order-head-title" v-show="!iptSearch">订单列表</div>
    ...
    <div class="tab_wrap">
      <ul class="ul_wrap">
        ...
        <li :class="{tab_active: active == item}" class="li_cell" v-for="(item,index) in dropList" v-on:click.stop="setSelectVal(item)">
              ...
              <!-- <span class="option_text" v-if="item === 14" data='14'>院内已作废</span> -->
        </li>
      </ul>
    ...
    <div class="mescroll" id="mescroll">
      <div id="dataList" class="data-list">  
        <div class="view-order-serach-result" :class="{'itemChoosed':itemChoosedFun(index)}"  v-for="(item,index) in pdlist" @click="ItemStatus(item,index)">
